...
- **Next（次のステップ、優先順）**:
  ...
  - 承認済み方針に沿った表示名・説明文の最終文言確定（[15_requester_review_items.md](./15_requester_review_items.md)の確認項目——サービス説明・Common Crawl補完・AI Overview/ChatGPT観測の表現・用語・優先順位——は方針レベルで承認済み。同ファイルの2章A〜F等の「候補」から実際に採用する表示名・説明文・改善提案文言を確定させる）
